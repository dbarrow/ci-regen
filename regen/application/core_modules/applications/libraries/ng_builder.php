...
class NG_Builder 
{
    ...
    {                  
        ...
        mkdir("../modules/" . $module_name . "/services"    , 0777);
        mkdir("../modules/" . $module_name . "/views"       , 0777);
        mkdir("../modules/" . $module_name . "/controllers" , 0777);     
        return true;
    }//end build_module
    ...
    private function write_files($module)
    {
        ...
        write_file("../modules/" . $module . "/controllers/" . $module  . 'ListController.js' , $controller);
        write_file("../modules/" . $module . "/controllers/" . $module  . 'ViewController.js' , $single_controller);
        write_file("../modules/" . $module . "/services/"    . $module  . 'Service.js'        , $service); 
        write_file("../modules/" . $module . "/config.js"                                     , $config); 
        write_file("../modules/" . $module . "/views/"       .  $data['lc_singular'] . ".html"   , $single_view); 
        write_file("../modules/" . $module . "/views/"       .  $data['lc_plural'] . ".html"   , $list_view); 
        write_file("../modules/" . $module . "/views/new-"       .  $data['lc_singular'] . ".html"   , $new_view); 
